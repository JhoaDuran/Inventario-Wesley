$(document).ready(function(){
  ...
  $.ajax({method: 'POST', url: "", dataType: 'json', data: {getPermisos : "permiso"},
    ...
    $('#agregarModal').attr(registrarPermiso, '');
      ...
      $('#cod_producto').keyup(()=> {validarStringLength($("#cod_producto"),$("#error1"),"Error de codigo",50) });
     ...
     //})
      ...
      $('#posologia').keyup(()=> {validarStringLength($("#posologia"),$("#error8"),"Error de posologia",400) });
      $('#contraIn').keyup(()=> {validarStringLength($("#contraIn"),$("#error9"),"Error elige ubicación",400) });
    ...
    $("#boton").click((e)=>{
      ...
      let cod_producto = validarStringLength($("#cod_producto"),$("#error1"),"Error del código",50);
      let tipoprod = validarSelect($("#tipoprod"),$("#error2"),"Error tipo producto");
      let presentacion = validarSelect($("#presentacion"),$("#error3"),"Error presentación");
      ...
      let composicion = validarStringLength($("#composicion"),$("#error7"),"Error de Composición", 50);
      let posologia = validarStringLength($("#posologia"),$("#error8"),"Error de posologia",400);
      let contraIn = validarStringLength($("#contraIn"),$("#error9"),"Error contraindicaciones",400);

      if(cod_producto && tipoprod && presentacion && laboratorio && tipoP && clase  && composicion && posologia  && contraIn){
  ...
  $('#cerrar').click(()=>{
   ...
   $(document).on('click', '.editar', function() {
      ...
      $('#cod_productoEd').keyup(() => validarStringLength($("#cod_productoEd"),$("#errorE1"),"Error del código"))
      $('#tipoprodEd').change(function(){
        validarSelect($("#tipoprodEd"),$("#errorE2"),"Error al seleccionar el nombre del producto");
      })
      ...
      $('#composicionEd').keyup(()=> {validarStringLength($("#composicionEd"),$("#errorE7"),"Error de Composición") });
      $('#posologiaEd').keyup(()=> {validarStringLength($("#posologiaEd"),$("#errorE8"),"Error de posologia") });
      $('#contraInEd').keyup(()=> {validarStringLength($("#contraInEd"),$("#errorE9"),"Error de contraindicaciones") });
      ...
      $("#actualizar").click((e)=>{
          ...
          let cod_productoE = validarStringLength($("#cod_productoEd"),$("#errorE1"),"Error del código", 50);
          let tipoprodE = validarSelect($("#tipoprodEd"),$("#errorE2"),"Error al seleccionar nombre del producto");  
          let presentaciónE = validarSelect($("#presentaciónEd"),$("#errorE3"),"Error presentación");
          let laboratorioE = validarSelect($("#laboratorioEd"),$("#errorE4"),"Error laboratorio");
          let tipoE = validarSelect($("#tipoEd"),$("#errorE5"),"Error tipo producto");
          let claseE = validarSelect($("#claseEd"),$("#errorE6"),"Error clase");
          let composicionE = validarStringLength($("#composicionEd"),$("#errorE7"),"Error de Composición", 50) ;
          let posologiaE = validarStringLength($("#posologiaEd"),$("#errorE8"),"Error de posologia",400) ; 
          let contraInE = validarStringLength($("#contraInEd"),$("#errorE9"),"Error de contraindicaciones", 400);
        


          if(cod_productoEd && tipoprodEd && presentaciónEd && laboratorioEd && tipoEd && claseEd && composicionEd && posologiaEd && contraInEd ){
